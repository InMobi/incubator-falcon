...
public class MemoryLocks {
    ...
    private HashMap<String, ReentrantLock> locks = new HashMap<String, ReentrantLock>();
    ...
    public class LockToken {
        ...
        LockToken(ReentrantLock lock, String entityName) {
            this.lock = lock;
    ...
    public LockToken getLock(String entityName) throws InterruptedException {
        ...
        synchronized (locks) {
            ...
            if (lockEntry.tryLock()) {
                ...
                return new LockToken(lockEntry, entityName);
            } else {
                return null;
            }
